...
namespace Braindigit\UserBundle\Command;
    ...
    protected function configure()
    {
        $this
            ...
            ->setDefinition(array(
                ...
                new InputArgument('fullname', InputArgument::REQUIRED, 'Full name'),
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $manipulator = $this->getContainer()->get('braindigit.util.user_manipulator');
        $manipulator->create($username, $password, $email, $fullname, !$inactive, $superadmin);
